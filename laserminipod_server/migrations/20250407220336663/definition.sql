...
--
-- Class RouteHandleState as table route_handle_state
--
...
--
-- Class RouteLikes as table route_likes
--
...
--
-- Class RouteUserProjects as table route_user_projects
--
...
-- Indexes
CREATE UNIQUE INDEX "route_user_projects_unique_idx" ON "route_user_projects" USING btree ("routeId", "userId");

--
-- Class RouteUserSents as table route_user_sents
--
CREATE TABLE "route_user_sents" (
    "id" bigserial PRIMARY KEY,
    "routeId" bigint NOT NULL,
    "userId" bigint NOT NULL
);
...
-- Indexes
CREATE UNIQUE INDEX "route_user_sents_unique_idx" ON "route_user_sents" USING btree ("routeId", "userId");

--
-- Class SpraywallName as table spraywall_name
--
...
--
-- Class SpraywallRoute as table spraywallroute
--
...
--
-- Foreign relations for "route_handle_state" table
--
...
--
-- Foreign relations for "route_likes" table
--
...
--
-- Foreign relations for "route_user_projects" table
--
...
--
-- Foreign relations for "route_user_sents" table
--
ALTER TABLE ONLY "route_user_sents"
    ADD CONSTRAINT "route_user_sents_fk_0"
    FOREIGN KEY("routeId")
    REFERENCES "spraywallroute"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
ALTER TABLE ONLY "route_user_sents"
    ADD CONSTRAINT "route_user_sents_fk_1"
    FOREIGN KEY("userId")
    REFERENCES "serverpod_user_info"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
...
--
-- Foreign relations for "spraywallroute" table
--
